...
#### Prepare Jenkins
- Fork the repository from <a href="https://github.com/manny-uncharted/php-todo.git">here</a> to your github account.
...
```
result:
![Jenkins PHP-TODO Pipeline](img/jenkins-php-todo-pipeline-unit-tests.png)


### Code Quality Analysis
This is one of the areas where developers, architects and many stakeholders are mostly interested in as far as product development is concerned. As a DevOps engineer, you also have a role to play. Especially when it comes to setting up the tools.

For PHP the most commonly tool used for code quality analysis is phploc. <a href="https://matthiasnoback.nl/2019/09/using-phploc-for-quick-code-quality-estimation-part-1/">Read more here</a>
...
```
result:
![Jenkins PHP-TODO Pipeline](img/jenkins-php-todo-pipeline-code-analysis.png)
...
```
result:
![Jenkins PHP-TODO Pipeline](img/jenkins-php-todo-pipeline-code-coverage.png)
...
result:
![Jenkins PHP-TODO Pipeline](img/jenkins-php-todo-pipeline-plot.png)
![PLOT](img/jenkins-php-todo-pipeline-plot-1.png)
...
```
result:
![Jenkins PHP-TODO Pipeline](img/jenkins-php-todo-pipeline-package-artifact.png)
...
```
result:
![Jenkins PHP-TODO Pipeline](img/jenkins-php-todo-pipeline-upload-artifact.png)
...
result:
![Sonarqube](img/jenkins-php-todo-pipeline-sonarqube-plugin.png)
...
result:
![Sonarqube](img/jenkins-php-todo-pipeline-sonarqube-config.png)

- Configure Quality Gate Jenkins Webhook in SonarQube – The URL should point to your Jenkins server http://{JENKINS_HOST}/sonarqube-webhook/
Navigate to Administration > Click on Configuration > Then on Webhooks > and then click on Create
result:
![Sonarqube](img/sonarqube-webhook.png)
...
result:
![Sonarqube](img/jenkins-sonarqube-scanner.png)
...
result:
![Sonarqube](img/php-todo-pipeline-sonarqube-scanner.png)
